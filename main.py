...
class Game:
    ...
    def new(self):
        ...
        self.start_game = False
        self.buttons_list = []
        self.buttons_list.append(Button(550, 100, 200, 50, "Shuffle", WHITE, BLACK))
        self.buttons_list.append(Button(550, 170, 200, 50, "Reset", WHITE, BLACK))
        self.draw_tiles()
    ...
    def draw(self):
        ...
        UIElement(550, 300, "High Score - %.3f" % (self.high_score if self.high_score > 0 else 0)).draw(self.screen)
        pygame.display.flip()
